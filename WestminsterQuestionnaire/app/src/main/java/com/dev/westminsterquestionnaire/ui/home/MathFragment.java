...
import com.dev.westminsterquestionnaire.DataModel.MathQuestions;
import com.dev.westminsterquestionnaire.DataModel.ScienceQuestions;
import com.dev.westminsterquestionnaire.R;
import com.dev.westminsterquestionnaire.databinding.FragmentMathBinding;
...
public class MathFragment extends Fragment {
    ...
    int totalQuestion = MathQuestions.questionMath.length;
    int score = 0;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.tvQuestion.setText(MathQuestions.questionMath[currentQuestionIndex]);
        binding.btnChoice1.setText(MathQuestions.choicesMath[currentQuestionIndex][0]);
        binding.btnChoice2.setText(MathQuestions.choicesMath[currentQuestionIndex][1]);
        ...
        binding.btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Objects.equals(countIndex , totalQuestion)) {
                    ...
                    Navigation.findNavController(v).navigate(R.id.action_mathFragment_to_scoreFragment, bundle);
        ...
        binding.btnChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Objects.equals(selectedAnswer, "")) {
                    ...
                    if (selectedAnswer.equals(MathQuestions.answersMath[currentQuestionIndex])) {
                        score++;
